...
namespace Checkers
{
    public partial class Form1 : Form
    {
        ...
        void squareEvent_Click(object sender, EventArgs e)
        {
            ...
            if (firstClick == null)
            {
                if (blackTurn && !square.isRed() && square.isOccupied())
                {
                    square.setRed(false);
                    square.setCurrent();
                    firstClick = square;
                ...
                else if (!blackTurn && square.isRed() && square.isOccupied())
                {
                    square.setRed(true);
                    square.setCurrent();
                    firstClick = square;
            ...
            else
            {
                ...
                if (blackTurn)
                {
                    if (canBlackMove())
                    {
                        ...
                        secondClick.BackColor = Color.DarkSlateGray;
                        secondClick.setKing(square.isKing());
                        secondClick.setRed(square.isRed());
        ...
        public bool canRedMove()
        {
            ...
            {
                if (secondClick != diagonalLeft && secondClick != diagonalRight)
                {
                    firstClick = null;
                    secondClick = null;
                    return false;
